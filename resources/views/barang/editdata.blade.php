                    ...
                    <div class="row row-cards">
                        ...
                        <div class="col-sm-6 col-md-6">
                            <div class="mb-3">
                                ...
                                <input class="form-control" id="tipebarang" name="tipe_barang"
                                    value="{{ $good->tipe_barang }}"></input>
                        ...
                        <div class="col-sm-6 col-md-6">
                            <div class="mb-3">
                                ...
                                <input class="form-control" id="merekbarang" name="merek_barang"
                                    value="{{ $good->merek_barang }}"></input>
                        ...
                        <div class="col-sm-6 col-md-6">
                            <div class="mb-3">
                                <label for="stok_alert" class="form-label">
                                    Minimum stok
                                    <span class="text-danger">*</span>
                                </label>
                                <input class="form-control" id="stok_alert" name="stok_alert"
                                    value="{{ $good->stok_alert }}"></input>
                        ...
                        <div class="col-sm-6 col-md-6">
                            <div class="mb-3">
                                <label for="rakbarang" class="form-label">
                                    Rak Barang
                                    <span class="text-danger">*</span>
                                </label>
                                <input class="form-control" id="rakbarang" name="rak_barang"
                                    value="{{ $good->rak_barang }}"></input>
                        ...
                        <div class="col-sm-6 col-md-6">
                            <div class="mb-3">
                                <label for="nomorrak" class="form-label">
                                    Nomor Rak
                                    <span class="text-danger">*</span>
                                </label>
                                <input class="form-control" id="nomorrak" name="nomor_rak"
                                    value="{{ $good->nomor_rak }}"></input>
