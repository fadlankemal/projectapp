...
@section('content')
    <div class="container-fluid mt-2 mx-6">
        ...
        <form method="POST" action="{{ url('outcomings') }}" class="" role="search">
            @csrf
            <div class="col-sm-6 col-md-6">
                ...
                <div class="mb-3">
                    <!-- <label for="status" class=""></label> -->
                    <input class="" id="status" name="status" value="Keluar" type="hidden"></input>
                </div>
                ...
                <!-- Operator -->
                <div class="mb-3">
                    <label for="tipebarang" class="form-label">PIC</label>
                    @if ($ops->count() === 1)
        ...
        <div class="table-responsive mt-2">
            <table id="outcoming" class="table table-hover">
                ...
                <tbody>
                    ...
                    @foreach ($items as $item)
                        <tr>
                            ...
                            @can('delete outcoming')
                                <td>
                                    <a href="{{ url('outcomings/' . $item->id . '/delete') }}" class="btn btn-danger btn-sm"
